...
Herkömmliche Texte über die Sylowsätze \cite{bibtex.a} behandeln Fragen der elementaren Zahlentheorie nicht in der Tiefe, sondern setzen eine gewisse mathematischen Vorkenntnis voraus.
In diesem Sinne führen auch wir die Zahlen abstrakt ein und fordern dann wohlbekannte Eigenschaften axiomatisch.
...
\begin{itemize}
\item Es wäre wünschenswert eine native 
...
\item Unterscheiden von Axiomen so handelt es sich bei der Forderung von und wirkliche Axiome, während die Forderungen von bekannten Eigenschaften wie dem Axiome \verb!cardUnion1! in Abschnitt.
...
Dies führt momentan dazu, dass Olean Datein
