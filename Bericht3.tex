...
Lean profititiert hier von den ausgeprägten Fehlermeldungen, die oftmals klar erkennbar machen, welche Zeile in welcher Form geändert werden müssen, um zu eine valide Datei zu erhalten. In Isabelle-Naproche 
