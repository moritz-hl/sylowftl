...
A formalization in [LEAN](https://leanprover.github.io) can be found at https://github.com/moritz-hl/sylow2 (based on [ChrisHughes24/Sylow](https://github.com/ChrisHughes24/Sylow)).
